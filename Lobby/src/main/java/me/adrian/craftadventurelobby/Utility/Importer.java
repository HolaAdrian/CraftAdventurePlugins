...
public class Importer {
    ...
    public static void ImportPermission(PluginManager pluginManager){
        ...
        pluginManager.addPermission(new Permission("lobby.startsmasher"));
        pluginManager.addPermission(new Permission("lobby.tempban"));
    }
    ...
    public static void ImportCommands(Lobby main){
        ...
        main.getCommand("ban").setExecutor(new TempBan());
    }
